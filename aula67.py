...
def monstrarMsg():
    messagebox.showerror(title="Pinchers Cursos",
                         message="Pnxrs Cursos, curso de lobinho")
...
btn_msg = Button(fr_quadro1, text="Mostrar mensagem", command=monstrarMsg)
...
lb_canal = Label(fr_quadro2, text="Pinchers Cursos",
                 background="#008", foreground="#fff", font=("Arial", 15))
